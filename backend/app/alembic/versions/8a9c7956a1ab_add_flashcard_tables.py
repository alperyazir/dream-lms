...
def upgrade():
    ...
    op.create_index(
        "idx_flashcard_set_class", "flashcard_sets", ["class_id"], unique=False
    )
    op.create_index(
        "idx_flashcard_set_teacher", "flashcard_sets", ["teacher_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "definition", sqlmodel.sql.sqltypes.AutoString(length=2000), nullable=False
        ),
        sa.Column(
            "translation", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True
        ),
        sa.Column(
            "example", sqlmodel.sql.sqltypes.AutoString(length=1000), nullable=True
        ),
        sa.Column(
            "part_of_speech", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=True
        ),
        sa.Column(
            "audio_url", sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True
        ),
        sa.Column(
            "cefr_level", sqlmodel.sql.sqltypes.AutoString(length=10), nullable=True
        ),
        sa.Column(
            "vocabulary_id", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("new", "learning", "known", name="flashcard_progress_status"),
            nullable=False,
        ),
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "student_id", "flashcard_id", name="uq_student_flashcard_progress"
        ),
    )
    op.create_index(
