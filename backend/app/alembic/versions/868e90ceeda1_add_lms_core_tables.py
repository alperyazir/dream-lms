...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["publisher_id"], ["publishers.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("dream_storage_id"),
    )
    op.create_index(
        op.f("ix_books_publisher_id"), "books", ["publisher_id"], unique=False
    )
    op.create_table(
        "activities",
        sa.Column(
    ...
    op.create_index(
        op.f("ix_activities_book_id"), "activities", ["book_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_assignments_activity_id"), "assignments", ["activity_id"], unique=False
    )
    op.create_index(
        op.f("ix_assignments_book_id"), "assignments", ["book_id"], unique=False
    )
    op.create_index(
        op.f("ix_assignments_teacher_id"), "assignments", ["teacher_id"], unique=False
    )
    op.create_index(
        "ix_assignments_due_date", "assignments", ["due_date"], unique=False
    )
    op.create_table(
        "classes",
        sa.Column("name", sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False),
        sa.Column(
            "grade_level", sqlmodel.sql.sqltypes.AutoString(length=50), nullable=True
        ),
        sa.Column(
            "subject", sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True
        ),
        sa.Column(
            "academic_year", sqlmodel.sql.sqltypes.AutoString(length=20), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("not_started", "in_progress", "completed", name="assignmentstatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_assignment_students_status", "assignment_students", ["status"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_class_students_class_id"), "class_students", ["class_id"], unique=False
    )
    op.create_index(
        op.f("ix_class_students_student_id"),
        "class_students",
        ["student_id"],
        unique=False,
    )
...
def downgrade():
    ...
    op.drop_index(
        "ix_assignment_students_completed_at", table_name="assignment_students"
    )
    op.drop_index("ix_assignment_students_status", table_name="assignment_students")
    op.drop_index(
        op.f("ix_assignment_students_student_id"), table_name="assignment_students"
    )
    op.drop_index(
        op.f("ix_assignment_students_assignment_id"), table_name="assignment_students"
    )
