...
def upgrade():
    ...
    op.add_column(
        "students", sa.Column("created_by_teacher_id", sa.Uuid(), nullable=True)
    )
    op.create_index(
        op.f("ix_students_created_by_teacher_id"),
        "students",
        ["created_by_teacher_id"],
        unique=False,
    )
    op.create_foreign_key(
        "fk_students_created_by_teacher_id",
        "students",
        "teachers",
        ["created_by_teacher_id"],
        ["id"],
...
def downgrade():
    op.drop_constraint(
        "fk_students_created_by_teacher_id", "students", type_="foreignkey"
    )
