...
def upgrade():
    ...
    op.add_column(
        "assignments", sa.Column("activity_type", sa.String(length=50), nullable=True)
    )
    op.add_column(
        "assignments", sa.Column("activity_content", sa.JSON(), nullable=True)
    )
    op.add_column(
        "assignments",
    ...
    op.add_column(
        "assignments", sa.Column("source_id", sa.String(length=255), nullable=True)
    )
