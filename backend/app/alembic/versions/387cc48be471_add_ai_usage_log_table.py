...
def upgrade():
    ...
    op.create_index(
        "idx_ai_usage_activity_type", "ai_usage_logs", ["activity_type"], unique=False
    )
    op.create_index(
        "idx_ai_usage_provider", "ai_usage_logs", ["provider"], unique=False
    )
    op.create_index(
        "idx_ai_usage_teacher", "ai_usage_logs", ["teacher_id"], unique=False
    )
    op.create_index(
        "idx_ai_usage_timestamp", "ai_usage_logs", ["timestamp"], unique=False
    )
    op.create_index(
        op.f("ix_ai_usage_logs_teacher_id"),
        "ai_usage_logs",
        ["teacher_id"],
        unique=False,
    )
