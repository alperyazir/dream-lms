...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["material_id"], ["teacher_materials.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(["teacher_id"], ["teachers.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        "idx_generated_content_material",
        "teacher_generated_content",
        ["material_id"],
        unique=False,
    )
    op.create_index(
        "idx_generated_content_teacher",
        "teacher_generated_content",
        ["teacher_id"],
        unique=False,
    )
    ...
    op.add_column(
        "teacher_materials", sa.Column("extracted_text", sa.Text(), nullable=True)
    )
    op.add_column(
        "teacher_materials", sa.Column("word_count", sa.Integer(), nullable=True)
    )
    op.add_column(
        "teacher_materials",
        sa.Column(
...
def downgrade():
    ...
    op.drop_index(
        "idx_generated_content_teacher", table_name="teacher_generated_content"
    )
    op.drop_index(
        "idx_generated_content_material", table_name="teacher_generated_content"
    )
