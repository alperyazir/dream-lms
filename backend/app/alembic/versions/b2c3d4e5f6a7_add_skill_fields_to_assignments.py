...
def upgrade():
    ...
    op.add_column(
        "assignments", sa.Column("primary_skill_id", sa.Uuid(), nullable=True)
    )
    op.add_column(
        "assignments", sa.Column("activity_format_id", sa.Uuid(), nullable=True)
    )
    op.add_column(
        "assignments",
        sa.Column("is_mix_mode", sa.Boolean(), nullable=False, server_default="false"),
    )
    ...
    op.create_index(
        op.f("ix_assignments_primary_skill_id"),
        "assignments",
        ["primary_skill_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_assignments_activity_format_id"),
        "assignments",
        ["activity_format_id"],
        unique=False,
    )
...
def downgrade():
    ...
    op.drop_constraint(
        "fk_assignments_activity_format_id", "assignments", type_="foreignkey"
    )
    op.drop_constraint(
        "fk_assignments_primary_skill_id", "assignments", type_="foreignkey"
    )
