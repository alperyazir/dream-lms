...
def upgrade():
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "book_id", "school_id", "teacher_id", name="uq_book_assignment"
        ),
    )
    op.create_index(
        op.f("ix_book_assignments_assigned_by"),
        "book_assignments",
        ["assigned_by"],
        unique=False,
    )
    op.create_index(
        op.f("ix_book_assignments_book_id"),
        "book_assignments",
        ["book_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_book_assignments_school_id"),
        "book_assignments",
        ["school_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_book_assignments_teacher_id"),
        "book_assignments",
        ["teacher_id"],
        unique=False,
    )
...
def downgrade():
    ...
    op.drop_index(
        op.f("ix_book_assignments_assigned_by"), table_name="book_assignments"
    )
