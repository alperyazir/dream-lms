...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["parent_id"], ["skill_categories.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("name"),
    )
    op.create_index(
        op.f("ix_skill_categories_slug"), "skill_categories", ["slug"], unique=True
    )
    op.create_index(
        "ix_skill_categories_is_active", "skill_categories", ["is_active"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_activity_formats_slug"), "activity_formats", ["slug"], unique=True
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["format_id"], ["activity_formats.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        op.f("ix_skill_format_combinations_skill_id"),
        "skill_format_combinations",
        ["skill_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_skill_format_combinations_format_id"),
        "skill_format_combinations",
        ["format_id"],
        unique=False,
    )
...
def downgrade():
    op.drop_index(
        op.f("ix_skill_format_combinations_format_id"),
        table_name="skill_format_combinations",
    )
    op.drop_index(
        op.f("ix_skill_format_combinations_skill_id"),
        table_name="skill_format_combinations",
