...
def upgrade():
    ...
    op.add_column(
        "teacher_generated_content", sa.Column("skill_id", sa.Uuid(), nullable=True)
    )
    op.add_column(
        "teacher_generated_content", sa.Column("format_id", sa.Uuid(), nullable=True)
    )
...
def downgrade():
    ...
    op.drop_constraint(
        "fk_generated_content_skill_id", "teacher_generated_content", type_="foreignkey"
    )
