...
class ContentItemPublic(BaseModel):
    ...
    material_id: UUID | None = Field(
        default=None, description="Material ID if material-based"
    )
    material_name: str | None = Field(
        default=None, description="Material name if material-based"
    )
    ...
    skill_id: UUID | None = Field(
        default=None, description="SkillCategory ID if generated via V2"
    )
    skill_name: str | None = Field(default=None, description="Skill category name")
    format_id: UUID | None = Field(
        default=None, description="ActivityFormat ID if generated via V2"
    )
...
class UpdateContentRequest(BaseModel):
    ...
    content: dict[str, Any] | None = Field(
        default=None, description="Updated content data"
    )
...
class AssignContentRequest(BaseModel):
    ...
    time_limit_minutes: int | None = Field(
        default=None, ge=1, description="Time limit in minutes"
    )
...
class BookContentItem(BaseModel):
    ...
    created_by_name: str | None = Field(
        default=None, description="Creator display name"
    )
