...
def test_admin_can_access_superuser_endpoints(client: TestClient, admin_token: str):
...
def test_unauthenticated_user_cannot_access_protected_endpoints(client: TestClient):
