...
1. Admin/Teacher creates student → System generates random password
2. Password hashed with bcrypt (irreversible)
3. `must_change_password = True` set on user
4. First login → Student forced to change password
5. Teacher cannot see or retrieve original password

### Proposed Password Flow

1. Admin/Teacher creates student → Can provide custom password OR auto-generate
...
│                     [👁] Show   [🔄] Generate    │
│                                                  │
│ ☑ Auto-generate password (uncheck to enter)     │
│                                                  │
...
│ Students                                     [+ Add] [Import]    │
├──────────────────────────────────────────────────────────────────┤
│ Name           │ Username    │ Class │ Actions                   │
├────────────────┼─────────────┼───────┼───────────────────────────┤
│ Ahmet Yılmaz   │ ahmet.y     │ 3A    │ [👁 Password] [✏] [🗑]    │
│ Elif Kaya      │ elif.k      │ 3A    │ [👁 Password] [✏] [🗑]    │
└──────────────────────────────────────────────────────────────────┘
```
...
│                                                  │
│ Password Strategy:                              │
│ ○ Auto-generate unique password for each        │
│ ○ Use passwords from Excel file                 │
│ ● Apply same password to all students           │
│                                                  │
│   Class Password: [_______________________]     │
│                   (e.g., "class3a-2024")        │
│                                                  │
│         [Back]                    [Continue]    │
└─────────────────────────────────────────────────┘
