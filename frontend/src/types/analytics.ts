...
// ============================================================================
// Teacher Insights Types - Story 5.4
// ============================================================================

/**
 * Type of insight detected by the analytics engine
 */
...
export interface AffectedStudent {
  student_id: string
  name: string
  relevant_metric: string // e.g., "Score: 45%", "3 past due"
}
...
/**
 * Response containing all insights for a teacher
 */
export interface TeacherInsightsResponse {
  insights: InsightCard[]
  last_refreshed: string // ISO 8601 datetime string
}
