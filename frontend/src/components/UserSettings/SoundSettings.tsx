  ...
  return (
    <div className="space-y-6">
        ...
        <div className="space-y-3 text-sm">
          <div className="flex items-center justify-between py-2 border-b border-border/30">
            <div>
              ...
              <p className="text-muted-foreground text-xs">
                Plays when you answer correctly
              </p>
            </div>
            <SoundPreviewButton
              type="correct"
          ...
          <div className="flex items-center justify-between py-2 border-b border-border/30">
            <div>
              ...
              <p className="text-muted-foreground text-xs">
                Sound when starting an activity
              </p>
            </div>
            <SoundPreviewButton
              type="activityStart"
          ...
          <div className="flex items-center justify-between py-2">
            <div>
              ...
              <p className="text-muted-foreground text-xs">
                Celebration sound when finishing
              </p>
            </div>
            <SoundPreviewButton
              type="complete"
      ...
      <p className="text-xs text-muted-foreground italic">
        Sound effects help reinforce learning through audio feedback. They can
        be especially helpful for younger learners.
      </p>
    </div>
  );
};
