...
export function StepAdditionalResources({
   ...
   * Stores full material data for preview mode support
   */
  const handleAddMaterials = (materials: Material[]) => {
    const newMaterialResources: TeacherMaterialResource[] = materials.map(
      (mat) => ({
        type: "teacher_material" as const,
        material_id: mat.id,
        name: mat.name,
        material_type: mat.type,
        // Store additional fields for preview mode
        url: mat.url,
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="space-y-2 shrink-0 mb-4">
        ...
        <p className="text-sm text-muted-foreground">
          Add supplementary materials for students to access during the
          assignment. You can control whether subtitles are shown for video
          resources.
        </p>
      </div>
              ...
              <div className="flex items-center justify-between">
                ...
                {hasVideos && (
                  <Badge variant="secondary">
                    {currentResources.videos.length} added
                  </Badge>
                )}
              </div>
              <CardDescription>
            ...
            <CardContent className="space-y-4">
              ...
              {hasMaterials && (
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    {(currentResources.teacher_materials ?? []).map(
                      (material) => (
                        <div
              ...
              <div className="flex flex-col items-center justify-center py-4">
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  Select documents, images, audio, videos, or links from your
                  library
                </p>
              </div>
            </CardContent>
