                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      !cellColor &&
                        inSelection &&
                        "bg-cyan-200 border-cyan-400 scale-110 shadow-md",
                      !cellColor &&
                        !inSelection &&
                        "bg-white border-slate-200 hover:bg-slate-50 hover:border-slate-300 hover:scale-105",
                    )}
                  >
                    {letter}
                  </div>
              ...
              >
                ...
                <span
                  className={cn(
                    ...
                    found
                      ? "text-slate-700 line-through decoration-2"
                      : "text-slate-700",
                  )}
                >
                  {word}
